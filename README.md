...
### `yarn startInOpenSuse`

as the scripts says it' will start in linux opensuse because opensuse uses HOST variable it has a conflict with react HOST variable
