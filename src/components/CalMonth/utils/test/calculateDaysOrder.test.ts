...
describe("calculateDaysOrder", () => {
  ...
  it("should return month of 1401/2", () => {
    const [firstWeek, secondWeek, thirdWeek, forthWeek, fifthWeek, sixWeek] =
      calculateDaysOrder(moment("1401/2/1", "jYYYY/jMM/jDD"));

    const firth = [27, 28, 29, 30, 31, 1, 2];
    const second = [3, 4, 5, 6, 7, 8, 9];
    const third = [10, 11, 12, 13, 14, 15, 16];
    const forth = [17, 18, 19, 20, 21, 22, 23];
    const fifth = [24, 25, 26, 27, 28, 29, 30];
    const six = [31, 1, 2, 3, 4, 5, 6];
